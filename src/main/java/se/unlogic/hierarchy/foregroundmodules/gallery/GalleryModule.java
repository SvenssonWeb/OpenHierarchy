...
public class GalleryModule extends AnnotatedForegroundModule implements CRUDCallback<User>, AccessInterface {
	...
	public ForegroundModuleResponse listGalleries(HttpServletRequest req, HttpServletResponse res, User user, URIParser uriParser, ValidationError validationError) throws SQLException {
